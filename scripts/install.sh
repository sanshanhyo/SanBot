...
write_env_file() {
  ...
  write_env_line "$env_file" "ENABLE_JAVLIBRARY" "true"
  ...
  write_env_line "$env_file" "JAVLIBRARY_BASE_URL" "https://www.javlibrary.com"
  write_env_line "$env_file" "JAVLIBRARY_LANGUAGE" "cn"
  write_env_line "$env_file" "JAVLIBRARY_PROVIDER_ORDER" "javlibrary,jav321,javdb,javbus"
  write_env_line "$env_file" "JAVDB_BASE_URL" "https://javdb.com"
  write_env_line "$env_file" "JAVBUS_BASE_URL" "https://www.javbus.com"
  write_env_line "$env_file" "JAV321_BASE_URL" "https://www.jav321.com"
  write_env_line "$env_file" "JAVLIBRARY_FETCHER" "curl"
  write_env_line "$env_file" "JAVLIBRARY_USER_AGENT" ""
  write_env_line "$env_file" "JAVLIBRARY_COOKIE" ""
  write_env_line "$env_file" "JAVLIBRARY_PROXY" ""
  write_env_line "$env_file" "JAVLIBRARY_IMPERSONATE" "random"
  write_env_line "$env_file" "JAVLIBRARY_RETRY_TIMES" "1"
  write_env_line "$env_file" "JAVLIBRARY_BROWSER_PROFILE_DIR" "/app/data/javlibrary-browser"
  write_env_line "$env_file" "JAVLIBRARY_BROWSER_CHANNEL" ""
  write_env_line "$env_file" "JAVLIBRARY_BROWSER_HEADLESS" "false"
  write_env_line "$env_file" "JAVLIBRARY_BROWSER_WAIT_SECONDS" "120"
